document.addEventListener("DOMContentLoaded", () => {
  ...
  // function likeBook(book){
    ...
    // if(book.users.find(othUser => othUser.username === user.username)){
      // newUsers = book.users.filter(othUser => othUser.username !== user.username)
      // let userLi = document.querySelector(`.user-li[data-id="${user.id}"]`)
      // userLi.remove()
    // } else {
